  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-10 text-center text-temple-maroon">
        ...
        >
          ...
          <TabsContent value="history">
            <Card className="border-temple-gold/30 shadow-xl bg-gradient-to-br from-white to-amber-50/50 hover:shadow-2xl transition-shadow duration-300">
              <CardContent className="pt-8 space-y-6">
                <div className="flex flex-col items-center mb-8">
                  <img 
                    src="/lovable-uploads/fab16119-9793-47b9-8c6a-59f2e83db43e.png" 
                    alt="Temple history image" 
                    className="rounded-lg max-w-full mb-5 shadow-xl ring-4 ring-amber-50 transform hover:scale-[1.01] transition-transform duration-300"
                    style={{ maxHeight: '60vh' }}
                  />
                  <p className="text-center text-sm italic mt-3 text-gray-600 max-w-2xl">
                    {language === 'en' 
          ...
          <TabsContent value="narsingh">
            <Card className="border-temple-gold/30 shadow-xl bg-gradient-to-br from-white to-amber-50/50 hover:shadow-2xl transition-shadow duration-300">
              <CardContent className="pt-8 space-y-6">
                <h2 className="text-2xl font-bold text-center text-temple-maroon mb-6">
                  {language === 'en'
                ...
                <h3 className="text-xl font-semibold text-temple-maroon mt-2">
                ...
                <ul className="list-disc pl-8 text-justify space-y-2 bg-amber-50/50 p-4 rounded-lg border border-amber-100/30">
                  <li className="leading-relaxed">{language === 'en' ? "He cannot be killed by a man or animal." : "न कोई मनुष्य उसे मार सके, न कोई पशु।"}</li>
                  <li className="leading-relaxed">{language === 'en' ? "He won't die during the day or night." : "न दिन में मरे, न रात में।"}</li>
                  <li className="leading-relaxed">{language === 'en' ? "He won't die inside or outside the house." : "न घर के भीतर मरे, न बाहर।"}</li>
                  <li className="leading-relaxed">{language === 'en' ? "Not in the sky or on the ground." : "न आकाश में, न पृथ्वी पर।"}</li>
                  <li className="leading-relaxed">{language === 'en' ? "Not by any weapon or tool." : "न किसी अस्त्र से, न किसी शस्त्र से।"}</li>
                </ul>
                ...
                <ul className="list-disc pl-8 text-justify space-y-2 bg-amber-50/50 p-4 rounded-lg border border-amber-100/30">
                  <li className="leading-relaxed">{language === 'en' ? "Thrown from a high mountain." : "उसे ऊँचे पर्वत से फेंका गया।"}</li>
                  <li className="leading-relaxed">{language === 'en' ? "Placed among venomous snakes." : "विषैले नागों के बीच डाला गया।"}</li>
                  <li className="leading-relaxed">{language === 'en' ? "Made to sit in fire with Holika." : "आग में बिठाया गया (होलिका के साथ)।"}</li>
                </ul>
                ...
                <ul className="list-disc pl-8 text-justify space-y-2 bg-amber-50/50 p-4 rounded-lg border border-amber-100/30">
                  <li className="leading-relaxed">{language === 'en' ? "Half-man, half-lion (not man or animal)" : "आधे मनुष्य और आधे सिंह के रूप में (न मनुष्य, न पशु)"}</li>
                  <li className="leading-relaxed">{language === 'en' ? "At twilight (not day or night)" : "संध्या समय (ना दिन, ना रात)"}</li>
                  <li className="leading-relaxed">{language === 'en' ? "On the threshold (neither inside nor outside)" : "द्वार की चौखट पर (ना अंदर, ना बाहर)"}</li>
                  <li className="leading-relaxed">{language === 'en' ? "On his lap (neither sky nor ground)" : "घुटनों पर बिठाकर (ना आकाश, ना पृथ्वी)"}</li>
                  <li className="leading-relaxed">{language === 'en' ? "With nails (neither weapon nor tool)" : "नाखूनों से चीरकर (ना अस्त्र, ना शस्त्र)"}</li>
                </ul>
                ...
                <ul className="list-disc pl-8 text-justify space-y-2 bg-amber-50/50 p-4 rounded-lg border border-amber-100/30">
                  <li className="leading-relaxed">{language === 'en' ? "God always protects his true devotees." : "भगवान अपने भक्तों की रक्षा हर परिस्थिति में करते हैं।"}</li>
                  <li className="leading-relaxed">{language === 'en' ? "No matter how great ego or tyranny is, Dharma always wins." : "अहंकार और अत्याचार चाहे कितना भी बड़ा क्यों न हो, धर्म की विजय होती है।"}</li>
                  <li className="leading-relaxed">{language === 'en' ? "Prahlad's patience, faith, and devotion remain an inspiration." : "भक्त प्रह्लाद का धैर्य, श्रद्धा और विश्वास आज भी प्रेरणा देता है।"}</li>
                </ul>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="features">
            <Card className="border-temple-gold/30 shadow-xl bg-gradient-to-br from-white to-amber-50/50 hover:shadow-2xl transition-shadow duration-300">
              <CardContent className="pt-8 space-y-6">
                <h3 className="text-2xl font-semibold text-center text-temple-maroon mb-6">
                  {language === 'en' ? 'Temple Features' : 'मंदिर की विशेषताएं'}
                </h3>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3 bg-amber-50/50 p-5 rounded-lg border border-amber-100/30 hover:shadow-md transition-shadow duration-300">
