      ...
      <div className="container mx-auto px-4 space-y-12">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          {language === 'en' ? (
            ...
            <div className="space-y-4">
              <p>श्री नरसिंह मंदिर हसामपुर को आपके उदार समर्थन और योगदान के लिए धन्यवाद। हम आपके दान की गहराई से सराहना करते हैं, जो हमारी धार्मिक और परोपकारी गतिविधियों को बनाए रखने में मदद करते हैं। अपने दान के साथ आगे बढ़ने से पहले कृपया हमारी धनवापसी नीति को ध्यान से पढ़ें।</p>
              
              <p><strong>गैर-वापसी योग्य योगदान:</strong> श्री नरसिंह मंदिर हसामपुर को किए गए सभी दान अंतिम और गैर-वापसी योग्य माने जाते हैं।</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          {language === 'en' ? (
            ...
            <div className="space-y-4">
              <p>श्री नरसिंह मंदिर हसामपुर आपकी गोपनीयता का सम्मान करता है और आपकी व्यक्तिगत जानकारी की सुरक्षा के लिए प्रतिबद्ध है। यह नीति बताती है कि हम आपके डेटा को कैसे एकत्र करते हैं, उपयोग करते हैं और सुरक्षित रखते हैं।</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          {language === 'en' ? (
            ...
            <div className="space-y-4">
              <p>श्री नरसिंह मंदिर हसामपुर एक धार्मिक और परोपकारी संस्थान है। प्राप्त सभी धनराशि का उपयोग विशेष रूप से मंदिर के रखरखाव, धार्मिक समारोहों और सामुदायिक सेवा पहलों के लिए किया जाता है।</p>
